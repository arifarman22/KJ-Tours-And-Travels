...
const process = [
  { step: "01", title: "Consultation", desc: "Discuss your visa requirements and destination" },
  { step: "02", title: "Documentation", desc: "Prepare and verify all required documents" },
  { step: "03", title: "Application", desc: "Submit visa application to embassy/consulate" },
  { step: "04", title: "Follow-up", desc: "Track application and handle queries" },
  { step: "05", title: "Visa Delivery", desc: "Receive your approved visa" }
];
        ...
        <div className="max-w-7xl mx-auto relative z-10 h-full flex items-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black font-montserrat text-white mb-6 uppercase tracking-tight">
              Visa <span className="text-kj-gold">Processing</span>
            </h1>
            <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
              Comprehensive visa assistance for tourist, student, and work visas worldwide
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-kj-blue mb-2">15-45 Days</h3>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-kj-blue mb-2">15+ Countries</h3>
              <p className="text-slate-600">Visa Services</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-kj-blue mb-2">98%</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-slate-600 mb-6 leading-relaxed">
                Our visa processing service covers all types of visas for multiple countries. We provide end-to-end support including document preparation, application submission, and follow-up with embassies.
              </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-8">
              Let us help you get your visa approved
            </p>
            <a
              href="/contact"
